...
typedef unsigned short MaterialVideoMode_t;
...
public:
	...
	IMaterialSystem UpdateConfig(bool bForceUpdate)
	{
		typedef IMaterialSystem(__thiscall* Fn)(void*, bool);
		return Utils::GetVFunc<Fn>(this, 20)(this, bForceUpdate);
	}
	IMaterialSystem OverrideConfig(const MaterialSystem_Config_t &config, bool bForceUpdate)
	{
		typedef IMaterialSystem(__thiscall* Fn)(void*, bool);
		return Utils::GetVFunc<Fn>(this, 21)(this, bForceUpdate);
	}
